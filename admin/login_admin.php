        ...
        <div class="card my-5">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-end mb-4">
              ...
              <a href="https://api.whatsapp.com/send?phone=5595981069925" target="_blank" rel="noopener noreferrer" class="link-primary">Não possui cadastro?</a>
            ...
            <div class="form-group mb-3">
              ...
              <input type="text" name="usuario" class="form-control" placeholder="000.000.000-00" required maxlength="14">
            </div>
            <div class="form-group mb-3">
            ...
            <div class="d-grid gap-2 mt-4">
              <button type="submit" class="btn btn-primary">Login</button>
                <a href="../usuarios/login_usuarios.php" class="btn btn-warning">Usuários externos</a>
            </div>
        ...
        <div class="auth-footer row">
          ...
          <div class="col-auto my-1">
            <ul class="list-inline footer-link mb-0">
              ...
              <li class="list-inline-item"><a href="../index.php#contact">Contact us</a></li>
            </ul>
          </div>
          <!-- </div> -->
        </div>

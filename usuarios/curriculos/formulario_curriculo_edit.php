...
<div  class="container mt-10 mb-5">
  <div class="card shadow border-0">
    <div class="card-header bg-warning text-white">
      <h3 class="mb-0">Edição de curriculo</h3>
    </div>
      ...
      <form action="salvar_curriculo.php" method="POST" class="card p-4 shadow-sm">
        ...
        <div class="row g-3">
          <div class="col-md-3">
            ...
            <input type="text" name="grau" value="<?php echo $formacoes['grau'] ?? ''; ?>" class="form-control"
              required>
          </div>
          <div class="col-md-5">
        ...
        <div class="row g-3">
          ...
          <div class="col-md-3">
            ...
            <input type="date" name="data_fim" value="<?php echo $experiencias['data_fim'] ?? ''; ?>"
              class="form-control" required>
          </div>
          <div class="col-md-3">
